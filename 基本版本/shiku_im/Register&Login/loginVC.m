...
//        [self.tableHeader addSubview:btn];
        ...
        n += 40;
        //酷聊icon
        UIImageView * kuliaoIconView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"app_icon"]];
        ...
        if (self.isSMSLogin) {
            ...
            _send = [UIFactory createButtonWithTitle:Localized(@"JX_Send")
                                          ...
                                          titleColor:[UIColor whiteColor]
                                              normal:nil
                                           highlight:nil ];
            _send.frame = CGRectMake(JX_SCREEN_WIDTH-75-55, self.view.bounds.size.height-100.0, 75, 32);
...
//        // 短信登录
//        UIImageView *smsLogin = [[UIImageView alloc] initWithFrame:CGRectMake((JX_SCREEN_WIDTH - wxWidth) / 2, loginY, wxWidth, wxWidth)];
//
...
//    }
    ...
    [WXApi sendAuthReq:req
        viewController:self
              delegate:[WXApiManager sharedManager] completion:^(BOOL success) {
