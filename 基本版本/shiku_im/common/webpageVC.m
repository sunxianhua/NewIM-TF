...
- (void)didBtnTurnThePage:(UIButton *)button {
    ...
    [self.webView highlightAllOccurencesOfString:self.textStr index:self.clickTime resultBlock:^(NSString * result) {
        
        self.keywordsNum = [result intValue];
...
- (BOOL)textFieldShouldReturn:(UITextField *)textField {
    if (textField.returnKeyType==UIReturnKeySearch) {
        ...
        [self.webView highlightAllOccurencesOfString:textField.text index:1 resultBlock:^(NSString * result) {
...
- (void)webView:(WKWebView *)webView didFinishNavigation:(WKNavigation *)navigation {
    ...
    [self.webView evaluateJavaScript:@"getImages()" completionHandler:^(NSString* urlResurlt, NSError * error) {
...
- (void)webView:(WKWebView *)webView decidePolicyForNavigationAction:(WKNavigationAction *)navigationAction decisionHandler:(void (^)(WKNavigationActionPolicy))decisionHandler{
    ...
    NSString* s = navigationAction.request.URL.absoluteString;
